...
/**
 * Client to invoke Trinsic Connect in an Android application.
 *<br/><br/>
...
public class ConnectClient {
    ...
    /**
     * Instantiate a ConnectClient and register the event callback for session execution results.
     * <br/><br/>
     * Must be called in an Activity's constructor or a Fragment's initialization logic (eg `onCreateView`).
     *
     * @param activity The Activity or Fragment this ConnectClient belongs to
     * @param callback A callback to capture the results of session invocation
     */
    public ConnectClient(@NonNull ActivityResultCaller activity, @NonNull Consumer<AcceptanceSessionResult> callback) {
     ...
     * <br/><br/>
     * The result of session invocation is delivered via the callback registered in the `ConnectClient` constructor.

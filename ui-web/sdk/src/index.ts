...
import { TrinsicPopup, WaitForResultsOptions, TrinsicPopupResultCode } from "./TrinsicPopup";
...
export type { SignalRedirectFromPopupOptions, CreatePopupAndWaitForResultsOptions, WaitForResultsOptions, MdlExchangeResult };

...
},{"@trinsic/web-ui":"ggtbx"}],"ggtbx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "launchIframe", ()=>Q);
parcelHelpers.export(exports, "launchPopup", ()=>X);
parcelHelpers.export(exports, "launchRedirect", ()=>V);
var h = ()=>{
...
var A, b, c, v, C, L = (A = [
    ...
    function t(e) {
        var n = e.targetModal, r = e.triggers, s = r === void 0 ? [] : r, l = e.onShow, d = l === void 0 ? function() {} : l, u = e.onClose, B = u === void 0 ? function() {} : u, p = e.openTrigger, F = p === void 0 ? "data-micromodal-trigger" : p, y = e.closeTrigger, P = y === void 0 ? "data-micromodal-close" : y, w = e.openClass, R = w === void 0 ? "is-open" : w, k = e.disableScroll, j = k !== void 0 && k, E = e.disableFocus, D = E !== void 0 && E, x = e.awaitCloseAnimation, N = x !== void 0 && x, _ = e.awaitOpenAnimation, K = _ !== void 0 && _, M = e.debugMode, z = M !== void 0 && M;
        (function(Y, q) {
            ...
            value: function() {
                ...
                if (this.modal.setAttribute("aria-hidden", "true"), this.removeEventListeners(), this.scrollBehaviour("enable"), this.activeElement && this.activeElement.focus && this.activeElement.focus(), this.config.onClose(this.modal, this.activeElement, e), this.config.awaitCloseAnimation) {
                    ...
                    this.modal.addEventListener("animationend", function s() {
                        n.classList.remove(r), n.removeEventListener("animationend", s, !1);
                    }, !1);
    ...
    init: function(t) {
        ...
        }, t), i = m(document.querySelectorAll("[".concat(o.openTrigger, "]"))), a = function(r, s) {
            var l = [];
        ...
        if (o.debugMode !== !0 || C(i, a) !== !1) for(var e in a){
            var n = a[e];
    ...
    show: function(t, o) {
        var i = o || {};
        i.targetModal = t, i.debugMode === !0 && v(t) === !1 || (c && c.removeEventListeners(), (c = new b(i)).showModal());
    },
    close: function(t) {
...
async function Q(t) {
    ...
    if (o.id = "trinsic-ui-style", o.textContent = T, document.head.appendChild(o), f.init(), t == null || t === "") throw new Error("Please specify a launch url by calling our API via one of our backend SDK's");
    H(t);
    var i = new Promise((a, e)=>{
        window.addEventListener("message", (n)=>{
            var r, s;
            console.debug("event data", n.data), ((r = n.data) == null ? void 0 : r.success) === !0 && (I(), a(n.data)), ((s = n.data) == null ? void 0 : s.success) === !1 && (I(), e(n.data));
        }, !1);
    });
    return i;
}
...
async function X(t) {
    ...
    var a = new Promise((e, n)=>{
        window == null || window.addEventListener("message", (r)=>{
            var s, l;
            console.debug("event data", r.data), ((s = r.data) == null ? void 0 : s.success) === !0 && (i == null || i.close(), e(r.data)), ((l = r.data) == null ? void 0 : l.success) === !1 && (i == null || i.close(), n(r.data));
        }, !1);
    });
    return a;
}
function H(t) {
    O();
    let o = h(), i = document.createElement("div");
    i.id = "trinsic-ui", i.ariaHidden = "true", i.className = "micromodal-slide";
    ...
    if (n.className = "h-full w-full bg-transparent", n.allow = "camera *; microphone *; display-capture *; publickey-credentials-get *; publickey-credentials-create *", n.src = t, e.append(n), a.append(e), i.append(a), document == null || document.body === null || document.body === void 0 || document.body.classList === null || document.body.classList === void 0) throw new Error("document.body.classList is null or undefined. Make sure you run this code after your DOM has loaded. You can use the event listener 'DOMContentLoaded' to ensure this.");
    document.body.classList.add("lock-bg"), document.body.append(i), f.show("trinsic-ui");
}
function I() {
    try {
        f.close("trinsic-ui");
    } catch (t) {}
    document.body.classList.remove("lock-bg"), O();
}
function O() {

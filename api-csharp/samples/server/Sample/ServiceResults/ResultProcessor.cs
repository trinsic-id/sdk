...
public static class ResultProcessor
{
    ...
    public static ProcessedResult ProcessSessionResult(object result)
    {
        ...
        // For now, return basic processed result since we're working with object type
        // In practice, you would cast to the specific result type based on your API
        return new ProcessedResult
        {
            SessionId = null, // Extract from result object based on actual type
            State = null,
            FailCode = null,
            FailReason = null,
            ResultCount = 0,
